...
import scala.reflect.internal.util.{BatchSourceFile, FreshNameCreator, NoSourceFile, Parallel, ScriptSourceFile, SourceFile}
...
import scala.tools.nsc.reporters.{BufferedReporter, Reporter => LegacyReporter}
